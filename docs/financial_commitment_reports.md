...
Financial commitment reports in Vantage help you understand your overall *discounted coverage*, *effective savings rate*, and *utilization*. These metrics are described in detail below.
...
$$
\frac{Covered\_Use}{Covered\ Use+On–Demand\_Use}
$$
...
$$
1 - \frac{Discounted\_Spend}{On–Demand\_Equivalent\_Spend}
$$
