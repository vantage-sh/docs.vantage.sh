...
4. Enter a **Name**.
5. Under **Widget Settings**, select the widgets you want displayed on the dashboard. Widgets are initially added to dashboards in chronological order, with the most recently added widget appearing at the bottom.
   :::note
...
<Tabs>
  <TabItem value="dashboard" label="From the Dashboard" default>
    <ol>
      ...
      <li>At the top, click <strong>Done Reordering</strong>. The new order is displayed on your dashboard.
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div style={{ 
