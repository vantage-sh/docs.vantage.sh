...
To request new service support on Vantage, email [support@vantage.sh](mailto:support@vantage.sh) with the subject line of *New GCP Service Support*. Include as much information as you can about the data you want to see.
</Note>
