...
- For **Budget Alerts**, you can optionally assign alerts once your budget is created. Any existing alerts will also be listed here. See the [section below](/budgets#create-alerts) for more details.
