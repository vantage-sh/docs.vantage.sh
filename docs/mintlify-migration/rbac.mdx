...
Account Owners can map SSO groups to teams within Vantage. The matching teams first need to be created following the steps above. Then, follow the [Set Up SSO Group Mapping for Teams](/sso#set-up-sso-group-mapping-for-teams) instructions for information on how to map teams.
...
- On the **General** tab, you can edit the team name and description as well as set a default team [dashboard](/dashboards#set-a-default-dashboard).
	<Info>
	**NOTE**
...
- On the **API Access Tokens** tab, Owners and Team Owners can create [API service tokens](/vantage_account#create-a-vantage-api-service-token) at the account level that inherit permissions from the team.
...
| --- | --- | --- | --- | --- | --- | --- |
| No Access | Owner |  | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  |
| No Access | Editor |  | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  |
| No Access | Viewer |  |  |  | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  |
| View Access | Owner |  | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |
| View Access | Editor |  | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  |
| View Access | Viewer |  |  |  | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  |
| Edit Access | Owner | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |
| Edit Access | Editor | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  <Icon icon="circle-check" iconType="solid" color="#6742D6"/>|  |
| Edit Access | Viewer |  |  |  | <Icon icon="circle-check" iconType="solid" color="#6742D6"/> |  |
