...
When a user navigates to `console.vantage.sh`, the **Overview** page is displayed. An individual user or owner of a team can configure a default dashboard to be displayed instead of the **Overview** page. See the [Default Dashboards](/dashboards#set-a-default-dashboard) documentation for details.
</Info>
