...
| --- | --- | --- |
| Cost Reports | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> |
| Usage Reports | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> |
| Resource Reports |  | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> |
| Kubernetes Efficiency Reports | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> |
| Financial Commitment Reports | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> | <Icon icon="circle-check" iconType="solid" color="#ad4dd6"/> |
