...
## <Icon size={24} color="#ad4dd6" iconType="solid"  icon="lightbulb" /> What Are Vantage Integrations?
...
## <Icon size={24} color="#ad4dd6" iconType="solid"  icon="pen" /> Integrations Use Cases
...
## <Icon size={24} color="#ad4dd6" iconType="solid"  icon="book-copy" /> Lesson 1: Creating Integrations in Vantage
...
## <Icon size={24} color="#ad4dd6" iconType="solid"  icon="book-copy" /> Lesson 2: Connecting Custom Providers
...
## <Icon size={24} color="#ad4dd6" iconType="solid"  icon="book-copy" /> Lesson 3: Creating Jira Issues in Vantage
