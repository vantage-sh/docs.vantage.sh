...
<Accordion title="Does Vantage hold any security certifications, such as SOC 1, SOC 2, or ISO 27001?">
...
<Accordion title="In terms of application security, how does Vantage deal with security reports received from security researchers? In other words, does Vantage have a bug bounty program or a straightforward process to report security issues?">
...
<Accordion title="Does Vantage support 2FA, SSO, or any defensive options?">

Yes. We support [SAML SSO](/sso), and 2FA is on the roadmap.

</Accordion>

<Accordion title="How is customers’ data protected, and who has access to Vantage data?">
...
<Accordion title="Do you have a list of third parties Vantage uses that explains what each third party is allowed to access and its purpose?">
...
<Accordion title="Do you have a security contact person in case of breaches?">
...
<Accordion title="Do you log access activities of Vantage’s employees who have access to the data?">

Yes.

</Accordion>

<Accordion title="Does Vantage store any information regarding cloud infrastructure in the database?">
...
<Accordion title="Does Vantage use fixed IP addresses when connecting to external providers, such as AWS or Azure?">
