...
<Steps>
  <Step>
  Navigate to the **[Financial Commitment Reports](https://console.vantage.sh/financial_planning/financial_commitment_reports)** screen. All existing reports are displayed. From this screen, you can edit and delete existing reports.
  </Step>
  <Step>
  To create a new report, click **New Report**.
  </Step>
  <Step>
  To filter costs, click the **Filters** button on the top left of the graph.
   ...
   - Click **Save**.
   <Accordion title="Click to view a visual example">
   <Frame>
     <img alt="GIF of filtering a commitment report for AWS category costs that are not usage" src="https://assets.vantage.sh/docs/filter-fcr.gif"/>
   </Frame>
   </Accordion>
   </Step>
   <Step>
   You can optionally edit your existing rules or add additional filter criteria.
   ...
   <Step>
   To save the report, click **Save as New.** Enter a report name, and click **Save**. (To edit this name, click the pencil icon in the breadcrumbs above the chart, next to the report's name.)
   </Step>
</Steps>
...
- Above the graph, click the **Group By** dropdown menu. Select one or more grouping options. You can group by charge type, commitment type, service, account, billing account, region, category, subcategory, instance type, and tag.
  <Accordion title="Click to view a visual example">
    <Frame>
      <img alt="Filtering a commitment report for AWS category costs that are not usage" src="https://assets.vantage.sh/docs/fcr-group.png"/>
    </Frame>
  </Accordion>
  ...
  **TIP**
  ...
  For a detailed breakdown of the **Charge Type** grouping, see the [Cost Reports](/cost_reports#charge-type-grouping-category) documentation.
  </Tip>
...
<Frame>
  <img alt="A view of a full financial commitment report" src="https://assets.vantage.sh/blog/hourly-granularity/hourly-granularity-console.png" />
</Frame>
...
<Frame>
  <img alt="A view of a full financial commitment report" src="https://assets.vantage.sh/docs/fcr-full-report.png" />
</Frame>
