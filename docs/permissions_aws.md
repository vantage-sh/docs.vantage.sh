...
Vantage requests certain IAM permissions to interact with your AWS account. All permissions are ReadOnly be default and the list of permissions was generated by looking at the AWS-managed IAM policy of ReadOnlyAccess and removing a number of permissions from that. The list of permissions can be viewed on our [provided CloudFormation Stack file](https://vantage-public.s3.amazonaws.com/vantage-integration-latest.json).
